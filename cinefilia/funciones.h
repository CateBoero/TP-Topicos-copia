...
/* ============================================================
   funciones.h - CUIL, normalizacion, validacion generica,
                 incidencias (matriz doble entrada) y alquiler
   ============================================================ */
...
/* ============================================================
   Codigos de error para miembros (indices de fila en la matriz)
   ============================================================ */
...
/* ============================================================
   Estructuras de incidencias: matriz de doble entrada
   Filas = tipo de error | Columnas = IDs afectados
   ============================================================ */
typedef struct {
    char     tipo[25];
    unsigned cantidad;
...
/* ============================================================
   Comparador de indice (clave dni/id)
   ============================================================ */
...
/* ============================================================
   Validacion generica con punteros a funciones
   ============================================================ */
...
/* Ordena las filas de la matriz por cantidad descendente (qsort) */
...
/* Verifica si existen los CSV fechados para la fecha dada */
int archivos_fechados_existen(t_fecha fp, const char *data_path);

/* Imprime el menu de operaciones */
void imprimir_menu(void);

/* Submenú de incidencias (opcion k del menú) */
